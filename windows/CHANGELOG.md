...
- 同步 macOS 的 Codex Desktop 26.727 选择器契约适配：`main[data-app-shell-main-surface]`、`header[data-app-shell-application-menu-bar]`、首页 `[role="main"]` 与消息回合 `[data-turn-key]`。Windows 同版本实测快照待 CI/实机补录，选择器保持双端同源。
