...
- Theme safety: empty/over-12 MB images, over-4096px/12MP dimensions, path escapes, symlinks/junctions, malformed JSON, unsupported schema versions, and unsupported formats are rejected before payload construction.
