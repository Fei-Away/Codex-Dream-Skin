...
try {
  ...
  foreach ($requiredCss in @(
    ...
    ':is(main.main-surface, main[class*="_MainContentSurface_"]) > :is(header.app-header-tint, header[class*="_Header_"])',
    ...
    ':is(main.main-surface, main[class*="_MainContentSurface_"]):has([role="main"])',
    ':is(main.main-surface, main[class*="_MainContentSurface_"]):not(:has([role="main"]))'
  )) {
