...
// Construct a one-entry Deflate archive independently from the production
// writer, which deliberately emits Store-only deterministic author packages.
function deflateZip(name, content) {
