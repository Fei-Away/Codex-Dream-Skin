...
- 新增可选内置预设 `Small & Beauty`（小而美）：使用克制的灰白层级、可访问的绿色状态语义、紧凑横向建议卡和原创抽象对话横幅；名称与视觉方向致谢 MyKeyVans 的 Telegram 主题「小而美 8.0」及原文“正确定义『小而美』”的表述，但不使用原主题文件或其参考的 WeChat v7 字段
