...
const temporaryTheme = await fs.mkdtemp(path.join(os.tmpdir(), "dream-skin-dollar-macos-"));
...
console.log("PASS: macOS payload preserves theme names containing replacement-pattern dollar sequences.");
