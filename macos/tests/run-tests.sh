...
"$ROOT/app/tests/run-tests.sh"

printf 'PASS: syntax, payload, runtime-state safety, custom-theme, config round-trips, HOME recovery, signed runtime, doctor, and macOS app checks.\n'
