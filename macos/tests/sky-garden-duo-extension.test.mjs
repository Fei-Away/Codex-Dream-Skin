...
const template = await fs.readFile(path.join(macosRoot, "assets", "sky-garden-duo-extension.js"), "utf8");
const css = await fs.readFile(path.join(macosRoot, "assets", "sky-garden-duo-extension.css"), "utf8");
...
assert.equal(duo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.motionFrames, 0);
assert.equal(duo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.motionPointerEvents, 0);
...
assert.equal(
  scaledDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.motionAvoidanceMode,
  "scaled",
);
assert.equal(
...
scaledDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure({ root: false, route: true, layout: false });
assert.equal(
...
const avoidanceChecksBeforeStableResize =
  scaledDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.motionAvoidanceChecks;
...
scaledDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure({ root: false, route: true, layout: true });
...
assert.equal(
  hiddenDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.motionAvoidanceMode,
  "hidden",
);
assert.equal(hiddenDuo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.cleanup(), true);
...
const previousDuoState = duo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__;
vm.runInNewContext(
...
const activeDuoState = duo.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__;
...
const firstCharacterCreateCount = decorated.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.characterIconCreates;
decorated.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure({ root: false, route: true, layout: false });
assert.equal(
  decorated.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.characterIconCreates,
...
assert.equal(decorated.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.cleanup(), true);
...
const defaultMetrics = defaults.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics;
...
shellFollow.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure({ root: true, route: false, layout: false });
assert.equal(
...
shellFollow.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure();
...
const cached = createFixture({
  ...
  art: { safeArea: "auto", taskMode: "auto" },
  artKey: "cached-art",
  artMetadata: synchronousWide.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.artMetadata,
...
assert.equal(cached.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.analysisCacheHits, 1);
assert.equal(cached.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.metrics.analysisRuns, 0);

const previousWideState = synchronousWide.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__;
const stableStyle = synchronousWide.nodes.get("codex-dream-skin-sky-garden-style");
...
assert.equal(synchronousWide.nodes.get("codex-dream-skin-sky-garden-style"), stableStyle);
...
await Promise.resolve();
nativeDark.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.ensure();
assert.equal(nativeDark.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.analysis.shell, "light");
...
assert.equal(explicit.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.analysis, null);
...
assert.equal(explicit.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__.cleanup(), true);
...
assert.equal(explicit.nodes.has("codex-dream-skin-sky-garden-style"), false);
...
assert.equal(explicit.root.classList.contains("codex-dream-skin"), false);
assert.equal(explicit.nodes.has("codex-dream-skin-sky-garden-style"), false);
assert.equal(explicit.window.__CODEX_DREAM_SKIN_SKY_GARDEN_STATE__, undefined);
